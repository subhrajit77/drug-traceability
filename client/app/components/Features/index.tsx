        ...
        <div className="mx-auto max-w-7xl my-0 md:my-40 pt-36 px-6 relative" id="features-section">
            ...
            <div className="grid lg:grid-cols-2 gap-x-4 gap-y-4">
                ...
                <div>
                    ...
                    <h2 className="text-offwhite text-3xl lg:text-5xl font-semibold leading-snug mb-6 text-center md:text-start">The most trusted platform</h2>
                    <p className="lg:text-lg font-normal text-bluish text-center md:text-start">PharmaLedger provides real-time traceability and secure, immutable records for supply chain management, ensuring data integrity and transparency. Its multi-industry applicability allows seamless integration across sectors, from pharmaceuticals to logistics and beyond.</p>
                </div>
                {/* Column-2 */}
                <div>
